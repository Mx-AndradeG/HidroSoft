    ...
    <div>
        <vue-final-modal v-model="modal_button.show"  @beforeOpen="beforeOpen" name="category_modal" lock-scroll="false" content-style="border-radius:25px"
            ...
            <div class="row mt-1 text-center">
                <h3 class="col-12" style="font-weight: bold;">{{ alvMethod == 'POST' ? 'Crear ':(disable ? 'Ver ':'Editar ' ) }}Producto</h3>
            </div>
                    ...
                    <alv-form id="alv" ref="form" :action="alvRoute" :method="alvMethod" @after-done="afterDone" :data-object="item">    
                        <div class="row">
                            <div class="col-md-12"><label for="inputName5" class="form-label">Nombre</label>
                                <input :disabled="disable" v-model="item.name" name="name" type="text" class="form-control" id="name" placeholder="Refresco">
                            </div>
                        </div>      
                        <div class="row">
                            <div class="col-md-12"><label for="inputName5" class="form-label mt-3">Descripcion</label>
                        ...
                        <div class="row">
                            <div class="col-md-6"><label for="inputName5" class="form-label mt-3">Codigo</label>
                                <input :disabled="disable" v-model="item.code" name="code" type="text" class="form-control" id="code" placeholder="12345678">
                            </div>
                            <div class="col-md-6"><label for="inputName5" class="form-label mt-3">Precio</label>
                                <input :disabled="disable" v-model="item.price" name="price" type="number" class="form-control" id="price" placeholder="$123">
                            </div>
                        </div>  
                        <div class="row">
            ...
            <div class="row justify-content-end" id="modal-footer">
                <div class="col-3" v-if="!disable">
                    <button form="alv" type="submit" class="w-100 btn btn-outline-primary d-flex justify-content-center">
...
export default {
    ...
    methods:{
        ...
        getData(){
            axios.get(route("categories.index"),{ params:{
