...
axios.get(route("product.index", {columns: JSON.stringify(['id','name','description','code','price','category_name','Formatted_created_at']), limit:_limit, page:_offset+1, orderBy:_orderBy, ascending:_ascending})).then((response) => {
