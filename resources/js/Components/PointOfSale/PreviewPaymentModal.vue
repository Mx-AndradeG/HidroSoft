          ...
          <div>
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="background-color: #F6F6FE; text-align: center;">Saldo de adeudo</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr  v-for="(item, index) in data " :key="index">
                        ...
                        <td style="text-align: center;">{{formatPrice(item.current_paid)}}</td>
...
export default {
  ...
  methods: {
    beforeOpen(e) {
      if (typeof e.ref.params._rawValue.deadline_id != "undefined" &&  typeof e.ref.params._rawValue.payment_plan_id != "undefined") {
        axios
          .get(route("sales.calculate.payments"), {
            params: {
              deadline_id: e.ref.params._rawValue.deadline_id,
              payment_plan_id: e.ref.params._rawValue.payment_plan_id,
              total_sale: e.ref.params._rawValue.total_sale,  
            },
          })
          .then((response) => {
