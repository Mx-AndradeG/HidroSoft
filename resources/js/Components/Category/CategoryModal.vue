    ...
    <div>
        <vue-final-modal v-model="modal_button.show"  @beforeOpen="beforeOpen" name="category_modal" lock-scroll="false" content-style="border-radius:25px"
            ...
            <div class="row mt-1 text-center">
                <h3 class="col-12" style="font-weight: bold;">{{ alvMethod == 'POST' ? 'Crear ':(disable ? 'Ver ':'Editar ' ) }}Categoria</h3>
            </div>
    ...
    methods:{
        ...
        beforeOpen(e){
           ...
           if(typeof e.ref.params._rawValue.id != "undefined" ){
                axios.get(route("categories.show", e.ref.params._rawValue.id),{ params:{
